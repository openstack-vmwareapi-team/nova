...
DcMap = collections.namedtuple('DcMap',
                               ['ref', 'name', 'folder'])
...
class VMwareVMOps(object):
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        dc_map = self.get_datacenter_ref_and_name(data_store_ref)
    ...
    def get_datacenter_ref_and_name(self, ds_ref):
        ...
        if not map:
            ...
            map = DcMap(ref=dc_obj.objects[0].obj,
                        name=dc_obj.objects[0].propSet[0].val,
                        folder=self._get_vmfolder_ref())
        ...
        while dcs:
            ...
            for dco in dcs.objects:
                ...
                for ds_ref in ds_refs:
                    self._datastore_dc_mapping[ds_ref] = DcMap(ref=dc_ref,
                                                               name=name,
                                                               folder=folder)
